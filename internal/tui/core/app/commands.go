...
const (
	...
	statusInterventionQueued     = "Intervention queued"
	statusInterventionCanceling  = "Canceling current run for intervention"
	...
	statusLoadingPastedText      = "Loading pasted text..."
	...
	statusUserQuestionRequired   = "Question requires your answer: type and press Enter"
	statusUserQuestionSubmitting = "Submitting user question answer"
	statusUserQuestionSubmitted  = "User question answer submitted"
